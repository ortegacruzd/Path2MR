This a 3D histology reconstruction pipeline that can be implemented with sparse histological sampling 
and in absence of an MRI reference. The pipeline is described in the following manuscript: (link pending)
